        ...
        <div className="bg-card border border-gray-800 rounded-2xl shadow-2xl w-full max-w-sm p-5 space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500 mt-1 leading-relaxed">Switching the course code to <span className="text-gray-300 font-mono">{pendingCourseCode}</span> will route future grades into that course's worksheet within this semester's workbook — creating a new sheet if it doesn't already exist.</p>
            </div>
          </div>
          <div className="flex gap-2">
            <button onClick={cancelCourseChange} className="flex-1 py-2 bg-gray-800 text-gray-300 text-[11px] font-bold rounded-lg hover:bg-gray-700 transition-all">Cancel</button>
        ...
        <div className="bg-card border border-gray-800 rounded-2xl shadow-2xl w-full max-w-sm p-5 space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500 mt-1 leading-relaxed">Switching to <span className="text-gray-300 font-mono">{pendingWorkbookChange.value}</span> will route future grades into a different semester workbook — creating a new one if it doesn't already exist.</p>
            </div>
          </div>
          <div className="flex gap-2">
            <button onClick={cancelWorkbookChange} className="flex-1 py-2 bg-gray-800 text-gray-300 text-[11px] font-bold rounded-lg hover:bg-gray-700 transition-all">Cancel</button>
