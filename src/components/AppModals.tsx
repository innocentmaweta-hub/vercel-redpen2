...
export function AppModals({ app }: AppModalsProps) {
    ...
    return <>
        ...
        <AnimatePresence>
            ...
            {modals.modalType === 'new' && <NewSemesterModal courses={workbookState.courses} onConfirm={(updates) => modals.handleCreateNewWorkbook(updates, newWorkbookDeps)} onSkip={() => modals.handleSkipSemester(() => { grading.setMarkingModeState('ai'); tools.resetTools(); })} onCancel={modals.closeModal} />}
