...
function normalizeEditedResult(nextResult: any) {
    ...
    // Never leave an old total/percentage/grade visible after a question mark
    // has been cleared or made invalid. Otherwise the user could save a stale
    // total that no longer matches the edited question marks.
